# Generated by Powerlevel10k configuration wizard on 2024-11-01 at 10:30 +04.
...
# dotted, left frame, black-ornaments, compact, many icons, concise,
...
() {
  ...
  function detect_language() {
    if [[ -f package.json ]]; then
      echo "⬢"  # Node.js
    elif [[ -f .python-version || -f requirements.txt ]]; then
      echo "🐍"  # Python
  ...
  function p10k_language_segment() {
    local LANG_ICON
    LANG_ICON=$(detect_language)
    [[ -n $LANG_ICON ]] && p10k segment -b "$LANG_ICON"
  }
